...
import { Search, Button, Logo , Avatar } from "../index.js";
        ...
        {authStatus ? (
          <>
            <div className="rounded-full sm:block hidden ">
              ...
              <div className="border-3 outline-1 outline-purple-400  w-13 h-13 border-white rounded-full">
              ...
              <div className="text-purple-400 font-semibold "> {username} </div>
              </div>
            </div>
          </>
        ) : (
