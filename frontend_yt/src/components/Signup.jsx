...
import { Logo, Button, Input, GetImagePreview, Spinner } from "./index";
...
const Signup = () => {
  ...
  if (loading) {
    return (
    <div className="mx-auto mt-16 h-4 w-24">
      <Spinner />
    </div>
    )  
  }
  return (
    <>
      <div className="w-full h-screen  text-white p-3 flex justify-center items-start sm:mt-8">
        <div className="flex flex-col bg-black space-y-2 justify-center items-center border border-slate-600 p-3">
