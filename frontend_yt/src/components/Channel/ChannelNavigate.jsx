...
function ChannelNavigate({ username, edit }) {
    if (edit) {
        return (
            <>
                <section className="text-white bg-black text-center w-full flex justify-evenly items-center border-b-2 border-slate-600 text-xs sm:text-base sm:mt-4 md:mt-0 mt-2 scroll-none">
                    <NavLink
    ...
    return (
        <>
            {/* channel options */}
            <section className="text-white w-full flex justify-evenly bg-black items-center border-b-2 border-slate-600 text-sm sm:text-base sm:mt-4 md:mt-0 mt-2">
                <NavLink
